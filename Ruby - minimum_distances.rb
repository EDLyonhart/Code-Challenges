    ...
    brute force method: double loop. compare every element against every other element.
      big-o = 0(n^2)
    optimized method: create a hash table of elements => [index[1], index[2], ...] compre those.
      big-o = O(n)
    '''
